...
#(e.g., if there are fixations on sugar and fat level within one alternative 
#and then sugar and protein level within another alternative, 
#values 1,1,2,2 would be assigned to the counter variable) 
